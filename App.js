...
export default class CameraScreen extends React.Component {
  ...
  renderChat() {
    return <ChatScreen onPress={this.toggleChat.bind(this)} />;
  }
      ...
      <Camera
        ...
        <View
          ...
          <TouchableOpacity
            ...
            onPress={this.toggleChat.bind(this)}>
            <Text style={styles.flipText}> Chat </Text>
          </TouchableOpacity>
  ...
  render() {
    ...
    const content = this.state.showGallery ? this.renderGallery() : this.state.showChat ? this.renderChat() : cameraScreenContent;
